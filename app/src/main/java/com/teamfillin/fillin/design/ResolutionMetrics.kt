package com.teamfillin.fillin.design

import android.app.Application
import androidx.annotation.Px
import com.teamfillin.fillin.App
...
val Number.pixel: Int
    @Px get() = App.resolutionMetrics.toDP(this.toInt())

val Number.dp: Int
    get() = App.resolutionMetrics.toPixel(this.toInt())

val Number.pixelFloat: Float
    @Px get() = App.resolutionMetrics.toDP(this.toInt()).toFloat()

val Number.dpFloat: Float
    get() = App.resolutionMetrics.toPixel(this.toInt()).toFloat()
